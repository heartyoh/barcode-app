...
exports.symdesc = symdesc;

exports.png = function(bcid, text, scale_width, scale_height, rotate, options) {
	...
	bw.scale(scale_width, scale_height);
	bw.push(text);
	bw.push(opts);
	bw.call(bcid);
...
exports.base64 = function(bcid, text, scale_width, scale_height, rotate, options) {
	var s = this.png(bcid, text, scale_width, scale_height, rotate, options);
